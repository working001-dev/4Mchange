...
<head>
	...
	<style>
		...
		.block-login button:focus:active {
			outline: none;
			width: 100%;
		}
		...
		.block-login button:focus>span,
		.block-login button:active>span,
		.block-login button:focus:active>span {
			opacity: 1;
		}
...
<body class="login-layout">
											...
											<fieldset>
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="text" class="form-control" placeholder="Username" name="userName" onblur="if($(this).val() != '') $(this).css('border','1px solid #D5D5D5')" />
												...
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="password" class="form-control" placeholder="Password" name="passWord" onblur="if($(this).val() != '') $(this).css('border','1px solid #D5D5D5')" />
	...
	<script type="text/javascript">
		...
		$(document).on("click", ".btn-login", function() {
			...
			let checkEmpty = input.toArray().filter(f => !$(f).val()).map(e => {
				$(e).css({
