            ...
            <div class="widget-body">
                <div class="widget-main">
                    ...
                    <div class="panel-list col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="panel-add">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 comp-add">
                                <div class="form-group">
								    <label class="control-label no-padding-right" for="form-field-1">Permission Group Name</label> 
								    <input type="text" name="groupPermission" placeholder="Group Permission Name" vali="true" vali--message="Please input name for create group." add--new="user">
								</div>
                                <div class="form-group">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="roleList" style="width:100%;"></table>                
                    </div>
                </div>
            </div>
        </div>  
