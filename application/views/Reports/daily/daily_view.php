		...
		<div id="signup-box" class="signup-box widget-box no-border">
			<div class="widget-body">
				<div class="widget-main">
					<h4 class="header green lighter bigger"><i class="ace-icon fa fa-info-circle blue"></i>4M Change Daily</h4>
					...
					<div class="p-action">
						...
						<div class="right-group">
							<div class="input-group" style="width: 200px; margin-right: 8px;">
								<input class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" value="<?=date('Y-m-d')?>" />
								<span class="input-group-addon">
